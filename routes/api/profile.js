...
router.delete('/experience/:exp_id', auth, async (req, res) => {
  try {      
      ...
      // Get remove index
      // Create an array of experience id's, and store the index of the requested experience id
...
router.delete('/education/:edu_id', auth, async (req, res) => {
  try {      
      ...
      // Get remove index
      // Create an array of education id's, and store the index of the requested experience id
...
router.get('/github/:username', async (req, res) => {
  try {
    ...
    request(options, (error, response, body) => {
      ...
      // transpose string from get request into json, then send back to client as json
